    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          ...
          >
            Creative Backend-focused Full Stack Developer with 1+ years of
            experience in building scalable, high-performance, and secure web
            applications
          </motion.p>
            ...
            >
              ...
              <div className="space-y-2 font-mono text-sm">
                ...
                >
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-green-600">'Amr Magdy'</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="text-gray-500">,</span>{" "}
                  <span className="text-green-600">'Nest.JS'</span>
                  <span className="text-orange-500">]</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="text-green-600">
                    'Backend-Driven Full Stack'
                  </span>
                  <span className="text-gray-500">,</span>{" "}
                  <span className="text-green-600">'System Design'</span>
                  <span className="text-orange-500">]</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
